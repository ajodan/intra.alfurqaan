...
'title' => 'Manage Jenis Transaksi',
'contentTitle' => 'Manage Jenis Transaksi',
])
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('jenistransaksi.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
      ...
      <table class="table table-striped" id="dataTable1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="row ml-3">
                <a href="{{ route('jenistransaksi.edit',$jenistransaksi->id) }}" class="btn btn-primary btn-sm">Ubah</a>
                <form method="POST" action="{{ route('jenistransaksi.destroy',$jenistransaksi->id) }}">
                  @csrf
                  @method('DELETE')
