...
'title' => 'Manage Topik Kajian',
'contentTitle' => 'Manage Topik Kajian',
])
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('topikkajian.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-striped" id="dataTable1">
        ...
        <tbody>
          ...
          <tr>
            <td>{{ $no++ }}</td>
            <td>{{ $topik->nm_topik_kajian }}</td>
            <td>
              <div class="row ml-3">
                <a href="{{ route('topikkajian.edit',$topik->id) }}" class="btn btn-primary btn-sm">Ubah</a>
                <form method="POST" action="{{ route('topikkajian.destroy',$topik->id) }}">
                  @csrf
                  @method('DELETE')
