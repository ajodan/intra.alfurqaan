			...
			<div class="card-body">
				...
				<div class="col-lg">
					<div class="card">
						<div class="card-body">
							<div class="row ml-2">
								<i class="fas fa-fw fa-credit-card fa-3x"> </i>
								<h4 class="ml-4 mt-2"><a href="{{ route('transfer.index') }}"> Transfer</a></h4>
							</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="row ml-2">
								...
								<h4 class="ml-4 mt-2"><a href="{{ route('setor.index') }}"> Setor</a></h4>
							</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="row ml-2">
								...
								<h4 class="ml-4 mt-2"><a href="{{ route('tarik.index') }}"> Penarikan</a></h4>
							</div>
				...
				<div class="col-lg">
					<div class="card">
						<div class="card-body">
							<div class="row ml-2">
								<i class="fas fa-fw fa-money-bill fa-3x"> </i>
								<h4 class="ml-4 mt-2"><a href="{{ route('saldo.index') }}"> Saldo</a></h4>
							</div>
