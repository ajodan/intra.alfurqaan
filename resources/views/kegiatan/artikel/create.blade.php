...
'contentTitle' => 'Tambah Artikel/Berita',
])
    ...
    <div class="card-body">
        <form action="{{ route('artikel.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" id="judul" placeholder="Judul Artikel" autofocus value="{{ old('judul') }}">
            ...
            {{-- <div class="form-group">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" id="slug" placeholder="Judul Artikel" required autofocus value="{{ old('slug') }}">
                @error('slug')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>    
            ...
            <div class="form-group">
                <input id="isi_artikel" type="hidden" name="isi_artikel" rows="20" cols="130" value="{{ old('isi_artikel') }}">
