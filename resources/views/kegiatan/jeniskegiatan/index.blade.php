...
'title' => 'Manage Jenis Kegiatan',
'contentTitle' => 'Manage Jenis Kegiatan',
])
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('jeniskegiatan.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-striped" id="dataTable1">
        ...
        <tbody>
          ...
          <tr>
            <td>{{ $no++ }}</td>
            <td>{{ $jeniskegiatan->nm_jenis_kegiatan }}</td>
            <td>
              <div class="row ml-3">
                <a href="{{ route('jeniskegiatan.edit',$jeniskegiatan->id) }}" class="btn btn-primary btn-sm">Ubah</a>
                <form method="POST" action="{{ route('jeniskegiatan.destroy',$jeniskegiatan->id) }}">
                  @csrf
                  @method('DELETE')
