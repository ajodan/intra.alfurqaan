...
'title' => 'Daftar Mubaligh/Ustadz',
'contentTitle' => 'Daftar Mubaligh/Ustadz',
])
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('mubaligh.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
          ...
          <tr>
            ...
            <td>
              <div class="row ml-3">
                ...
                <form method="POST" action="{{ route('mubaligh.destroy',$ust->id) }}">
                  @csrf
                  @method('DELETE')
