...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('admin.jabatan.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
      ...
      <table class="table table-striped" id="dataTable1">
        ...
        <tbody>
          ...
          <tr>
            <td>{{ $no++ }}</td>
            <td>{{ $jab->id }}</td>
            <td>{{ $jab->nm_jabatan }}</td>
            <td>
              <div class="row ml-3">
                <a href="{{ route('admin.jabatan.edit',$jab->id) }}" class="btn btn-primary btn-sm">Ubah</a>
