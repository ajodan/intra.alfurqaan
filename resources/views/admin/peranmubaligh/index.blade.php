...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('admin.peranmubaligh.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
      ...
      <table class="table table-striped" id="dataTable1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="row ml-3">
                <a href="{{ route('admin.peranmubaligh.edit',$jab->id) }}" class="btn btn-primary btn-sm">Ubah</a>
                <form method="POST" action="{{ route('admin.peranmubaligh.destroy',$jab->id) }}">
                  @csrf
                  @method('DELETE')
