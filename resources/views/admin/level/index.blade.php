...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <a href="{{ route('admin.level.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> Tambah Data</a>
  </div>
  <div class="card-body">
      ...
      <table class="table table-striped" id="dataTable1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="row ml-3">
                <a href="{{ route('admin.level.edit',$lev->id) }}" class="btn btn-primary btn-sm">Ubah</a>
                <form method="POST" action="{{ route('admin.level.destroy',$lev->id) }}">
                  @csrf
                  @method('DELETE')
